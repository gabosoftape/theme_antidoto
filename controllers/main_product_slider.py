...
class WebsiteSale(WebsiteSale):
    ...
    def get_products_content(self, **post):
        ...
        if post.get('tab_id'):
            ...
            return request.render("theme_laze.product_slider_content", {'product_collection':tab_data,'compute_currency': compute_currency})
        return ''    
    ...
    def get_product_brand_slider(self, **post):
        ...
        return request.render("theme_laze.brand_slider_content", value)  
    ...
    def get_multi_tab_content(self, **post):
        ...
        if post.get('collection_id'):
            ...
            return request.render("theme_laze.s_collection_configure", value)
    ...
    def multi_tab_product_snippet(self, **post):
        ...
        return request.render("theme_laze.product_tab_content", value)
